    ...
    <div className="container mx-auto py-12 px-0">
      ...
      <div className="flex flex-col items-center mb-12">
        ...
        <p className="mt-4 text-lg text-center max-w-2xl">
          Наша місія - допомогти людям ефективно використовувати енергію, забезпечуючи інструменти для розрахунку
          енергоефективності. Ми не надаємо платних послуг, а прагнемо зробити енергозбереження доступним для всіх.
        </p>
      </div>
